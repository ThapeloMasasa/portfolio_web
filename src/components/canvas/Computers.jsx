...
const ComputerCanvas = () =>{
  ...
  useEffect(() =>{
    ...
    //define callback funstion to handle the changes
    const handleMediaQueryChange = (event) =>{
      setIsMobile(event.matches);
    }
    //add the call backfunction as a listener to the changes
    mediaQuery.addEventListener('change', handleMediaQueryChange);
    // remove the listener when a componennt is unmounted
    return () =>{
